...
//    val stream: DataStream[Any] = env.fromElements(1, 0.435, "hello", ("word", 1))

    //2.从文件读取数据
    val stream2: DataStream[String] = env.readTextFile("E:\\IdeaProjects\\test_flink\\src\\main\\resources\\sensor.txt")
