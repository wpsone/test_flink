...
public class WordCount4 {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WordAndCount> result = dataStream.flatMap(new SplitFlatMapTask())
                .keyBy("word")
    ...
    public static class SplitFlatMapTask implements FlatMapFunction<String,WordAndCount> {
